...
variable "keyvault_id" {
  description = "The id of the keyvault to store credentials and certs for kube config. If null, it will not be stored"
  type        = string
  default = null
}

variable "naming_prefix" {
  description = "The prefix to use secrets stored by this module"
  type        = string
  default     = ""
}


#default variables oss
