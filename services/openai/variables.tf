...
variable "kind" {
  type        = string
  default     = "OpenAI"
  description = "Specifies the kind of Cognitive Service Account. Possible values are `Bing.Autosuggest.v7`, `Bing.CustomSearch`, `Bing.Search.v7`, `Bing.SpellCheck.v7`, `ComputerVision`, `ContentModerator`, `CustomSpeech`, `Emotion`, `Face`, `FormRecognizer`, `LanguageUnderstanding`, `LUIS`, `MetricsAdvisor`, `QnAMaker`, `SpeakerRecognition`, `SpeechServices`, `TextAnalytics`, `TextTranslation`, `Translator`, `WebLM`, `OpenAI` and `All`. Default to `OpenAI`."  
}
