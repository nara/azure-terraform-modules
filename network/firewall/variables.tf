...
variable "firewall_subnet_id" {
  description = "The id of the subnet to deploy the firewall"
}

variable "firewall_management_subnet_id" {
  description = "The id of the subnet to deploy the firewall management"
}

variable "firewall_management_subnet_address_prefix" {
  description = "The prefix of the subnet to deploy the firewall management"
  default = ""
}
